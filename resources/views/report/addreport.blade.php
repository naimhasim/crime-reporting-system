...
L.control.locate().addTo(markermap);
...
markermap.on("moveend", function () {
  console.log(markermap.getCenter().toString());
    document.getElementById('latitude').value = markermap.getCenter().lat;
  document.getElementById('longitude').value = markermap.getCenter().lng;
});
